                            ...
                            <g id="Assets" stroke="none" strokeWidth="1" fill="none" fillRule="evenodd">
                                <g id="Group-28">
                                    <path
                                        ...
                                        id="Case" stroke="#141C3A" strokeWidth="8" fill="#FFFFFF"/>
                                    <path
                                        ...
                                        id="Case" stroke="#6E07F3" strokeWidth="8" fill="#8b00ff"/>
                                    <path
                                    ...
                                    <circle id="Oval-7" stroke="#141C3A" strokeWidth="8" fill="#5BE9B9"
                                            cx="287.5"
                                            cy="653.5" r="153.5"/>
                                    <path
                                    ...
                                    <path
                                        ...
                                        id="Notch" stroke="#141C3A" strokeWidth="8" fill="#FFFFFF"/>
                                    ...
                                    <g id="Group-69" transform="translate(695.000000, 0.000000)">
                                        ...
                                        <path
                                            ...
                                            id="Case" stroke="#141C3A" strokeWidth="8" fill="#141C3A"/>
                                        <path
                                    ...
                                    <g id="Group-68" transform="translate(1598.000000, 319.000000)">
                                        ...
                                        <g id="Group-61" transform="translate(219.000000, 139.000000)">
                                            <circle id="Oval-6" stroke="#6E07F3" strokeWidth="9" cx="116"
                                                    cy="116"
                                                    r="100"/>
                                            <path d="M129,4 L105,4 L105,28 L129,28 L129,4 Z" id="Rectangle-12"
                                                  stroke="#5BE9B9" strokeWidth="8" fill="#FFFFFE"/>
                                            <path d="M128,204 L104,204 L104,228 L128,228 L128,204 Z"
                                                  id="Rectangle-12" stroke="#5BE9B9" strokeWidth="8"
                                                  fill="#FFFFFE"/>
                                    ...
                                    <g id="Group-78" transform="translate(2080.000000, 948.000000)">
                                        <path
                                            ...
                                            id="Oval-8" stroke="#141C3A" strokeWidth="8.4" fill="#FFFFFF"/>
                                    ...
                                    <g id="Group-27" transform="translate(0.000000, 885.000000)">
                                        <path
                                            ...
                                            id="Rectangle-17" stroke="#141C3A" strokeWidth="8" fill="#6E07F3"/>
                                        <path
                                            ...
                                            id="Rectangle-19" stroke="#141C3A" strokeWidth="8" fill="#FFFFFF"/>
                                        <path
