            ...
            <div className="container">
                <div className="row">
                    <div className="portfolio__topic text-center">
                        <h2 className="portfolio__port-topic fs-1">
                            My Portfolio
                        </h2>
                        <h4 className="mb-3">Here are a few past design projects I've worked on. </h4>
                    </div>
                    <div className="col-4">
                        <a href="https://atlas-main-isr.netlify.app/">
                            <div className="portfolio-blocks atlas ">
                                <div className="overlay">
                                    The Atlas API Project is a software tool that provides developers with easy access
                                    ...
                                    working with geographic data, making it easier to build applications that use this
                                    information.
                                </div>
                            </div>
                        </a>
                    ...
                    <div className="col-4">
                        <a href="https://new-ehya.netlify.app/">
                            <div className="portfolio-blocks ehya">
                                <div className="overlay">
                                    EhyaSpace is the collaboration hub that brings the right people, information, and
                                    tools together to get work done. From Fortune 100 companies to corner markets,
                                    millions of people around the world use Slack to connect their teams, unify their
                    ...
                    <div className="col-4">
                        <a href="https://new-year-ws.netlify.app/">
                            <div className="portfolio-blocks cmas">
                                <div className="overlay">
                                    As the holiday season approaches and the air becomes crisp and cool, we at Christmas
                                    Shop
