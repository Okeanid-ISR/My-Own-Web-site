            ...
            <div className="container">
                <div className="d-flex justify-round justify-content-center">
                    <svg xmlns="http://www.w3.org/2000/svg" width="800" height="330"
                         viewBox="0 0 2493 1011" version="1.1">
                        ...
                        <g id="Assets" stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
                            <g id="Group-28">
                                <path
                                    ...
                                    id="Case" stroke="#141C3A" stroke-width="8" fill="#FFFFFF"/>
                                <path
                                    ...
                                    id="Case" stroke="#6E07F3" stroke-width="8" fill="#8b00ff"/>
                                <path
                                ...
                                <path
                                    ...
                                    id="Keyboard" stroke="#141C3A" stroke-width="8" fill="#FFFFFF"
                                    transform="translate(999.500000, 992.500000) scale(1, -1) translate(-999.500000, -992.500000) "/>
                                <circle id="Oval-6" stroke="#141C3A" stroke-width="8" cx="999.5" cy="784.5"
                                        r="18.5"/>
                                <rect id="Case" stroke="#141C3A" stroke-width="8" fill="#FFFFFF" x="389"
                                      y="618"
                                      width="198" height="389" rx="24"/>
                                <path d="M587,662 L389,662 L389,949.3 L587,949.3 L587,662 Z" id="Case"
                                      stroke="#141C3A" stroke-width="8" fill="#141C3A"/>
                                <rect id="Rectangle-11" fill="#141C3A" x="441" y="636" width="95" height="8"
                                      rx="4"/>
                                <rect id="Rectangle-11" fill="#141C3A" x="477" y="966" width="22.8"
                                      height="22.8" rx="11.4"/>
                                <circle id="Oval-6" stroke="#6E07F3" stroke-width="8" fill="#6E07F3"
                                        cx="445"
                                        cy="805" r="15"/>
                                <g id="Group-73" transform="translate(480.000000, 779.000000)"
                                   fill="#FFFFFF">
                                ...
                                <circle id="Oval-7" stroke="#141C3A" stroke-width="8" fill="#5BE9B9"
                                        cx="287.5"
                                        cy="653.5" r="153.5"/>
                                <path
                                ...
                                <path
                                    ...
                                    id="Notch" stroke="#141C3A" stroke-width="8" fill="#FFFFFF"/>
                                <rect id="Screen" fill="#5BE9B9" x="1257" y="511" width="681.406563"
                                      height="411.849582" rx="8"/>
                                <g id="Group-69" transform="translate(695.000000, 0.000000)">
                                    ...
                                    <path
                                        ...
                                        id="Case" stroke="#141C3A" stroke-width="8" fill="#141C3A"/>
                                    <path
                                    ...
                                    <g id="Group-72" transform="translate(52.000000, 143.000000)">
                                        <rect id="Rectangle-11" fill="#535B6B" opacity="0.54" x="0" y="200"
                                              width="18" height="8" rx="4"/>
                                        <rect id="Rectangle-11" fill="#535B6B" opacity="0.54" x="0" y="0"
                                              width="18" height="8" rx="4"/>
                                        <path
                                        ...
                                        <path
                                            ...
                                            id="Rectangle-11" fill="#6E07F3"/>
                                        <rect id="Rectangle-11" fill="#535B6B" opacity="0.54" x="0" y="40"
                                              width="18" height="8" rx="4"/>
                                        <rect id="Rectangle-11" fill="#535B6B" opacity="0.54" x="0" y="80"
                                              width="18" height="8" rx="4"/>
                                        <rect id="Rectangle-11" fill="#535B6B" opacity="0.54" x="0" y="120"
                                              width="18" height="8" rx="4"/>
                                        <rect id="Rectangle-11" fill="#535B6B" opacity="0.54" x="0" y="160"
                                              width="18" height="8" rx="4"/>
                                        <rect id="Rectangle-11" fill="#535B6B" opacity="0.54" x="0" y="240"
                                              width="18" height="8" rx="4"/>
                                        <rect id="Rectangle-11" fill="#535B6B" opacity="0.54" x="0" y="280"
                                              width="18" height="8" rx="4"/>
                                        <rect id="Rectangle-11" fill="#6E07F3" x="30" y="40" width="70"
                                              height="8" rx="4"/>
                                        <rect id="Rectangle-11" fill="#5BE9B9" x="110" y="40" width="120"
                                              height="8" rx="4"/>
                                        <rect id="Rectangle-11" fill="#6E07F3" x="240" y="40" width="50"
                                              height="8" rx="4"/>
                                        <rect id="Rectangle-11" fill="#5BE9B9" x="30" y="80" width="50"
                                              height="8" rx="4"/>
                                        <rect id="Rectangle-11" fill="#6E07F3" x="90" y="80" width="50"
                                              height="8" rx="4"/>
                                        <rect id="Rectangle-11" fill="#6E07F3" x="150" y="80" width="30"
                                              height="8" rx="4"/>
                                        <rect id="Rectangle-11" fill="#6E07F3" x="30" y="120" width="100"
                                              height="8" rx="4"/>
                                        <rect id="Rectangle-11" fill="#6E07F3" x="140" y="120" width="70"
                                              height="8" rx="4"/>
                                        <rect id="Rectangle-11" fill="#6E07F3" x="30" y="160" width="100"
                                              height="8" rx="4"/>
                                        <rect id="Rectangle-11" fill="#5BE9B9" x="140" y="160" width="130"
                                              height="8" rx="4"/>
                                        <rect id="Rectangle-11" fill="#6E07F3" x="30" y="200" width="70"
                                              height="8" rx="4"/>
                                        <rect id="Rectangle-11" fill="#5BE9B9" x="110" y="200" width="70"
                                              height="8" rx="4"/>
                                        <rect id="Rectangle-11" fill="#6E07F3" x="190" y="200" width="40"
                                              height="8" rx="4"/>
                                        <rect id="Rectangle-11" fill="#6E07F3" x="30" y="240" width="130"
                                              height="8" rx="4"/>
                                        <rect id="Rectangle-11" fill="#5BE9B9" x="30" y="280" width="60"
                                              height="8" rx="4"/>
                                    </g>
                                </g>
                                <g id="Group-68" transform="translate(1598.000000, 319.000000)">
                                    ...
                                    <g id="Group-61" transform="translate(219.000000, 139.000000)">
                                        <circle id="Oval-6" stroke="#6E07F3" stroke-width="9" cx="116"
                                                cy="116"
                                                r="100"/>
                                        <path d="M129,4 L105,4 L105,28 L129,28 L129,4 Z" id="Rectangle-12"
                                              stroke="#5BE9B9" stroke-width="8" fill="#FFFFFE"/>
                                        <path d="M128,204 L104,204 L104,228 L128,228 L128,204 Z"
                                              id="Rectangle-12" stroke="#5BE9B9" stroke-width="8"
                                              fill="#FFFFFE"/>
                                        <path d="M28,105 L4,105 L4,129 L28,129 L28,105 Z" id="Rectangle-12"
                                              stroke="#5BE9B9" stroke-width="8" fill="#FFFFFE"/>
                                        <line x1="216" y1="26" x2="216" y2="101" id="Line" stroke="#141C3A"
                                              stroke-width="8" stroke-linecap="square"/>
                                        <line x1="216" y1="131" x2="216" y2="206" id="Line" stroke="#141C3A"
                                              stroke-width="8" stroke-linecap="square"/>
                                        <circle id="Oval-5" fill="#141C3A" cx="216" cy="23" r="12"/>
                                        <circle id="Oval-5" fill="#141C3A" cx="216" cy="213" r="12"/>
                                        <path d="M227,105 L203,105 L203,129 L227,129 L227,105 Z"
                                              id="Rectangle-12" stroke="#5BE9B9" stroke-width="8"
                                              fill="#FFFFFE"/>
                                    </g>
                                    <g id="Group-60" transform="translate(90.000000, 130.000000)">
                                        <rect id="Rectangle-15" fill="#141C3A" x="0" y="0" width="70"
                                              height="70" rx="12"/>
                                        <rect id="Rectangle-15" fill="#5BE9B9" x="0" y="90" width="70"
                                              height="70" rx="12"/>
                                        <rect id="Rectangle-15" fill="#6E07F3" x="0" y="180" width="70"
                                              height="70" rx="12"/>
                                    </g>
                                </g>
                                <g id="Group-65" transform="translate(2253.000000, 800.000000)"
                                   stroke="#141C3A"
                                   stroke-width="8">
                                    <g id="Group-64" transform="translate(116.000000, 51.000000)"
                                       fill="#FFFFFF">
                                    ...
                                    <path
                                        ...
                                        id="Rectangle-16" fill="#5BE9B9"/>
                                    <line x1="114.5" y1="16.5" x2="114.5" y2="62" id="Line-2"
                                ...
                                <g id="Group-78" transform="translate(2080.000000, 948.000000)">
                                    <path
                                        ...
                                        id="Oval-8" stroke="#141C3A" stroke-width="8.4" fill="#FFFFFF"/>
                                    <rect id="Rectangle-11" fill="#141C3A" x="59" y="5" width="8"
                                          height="13"
                                          rx="4"/>
                                </g>
                                <g id="Group-27" transform="translate(0.000000, 885.000000)">
                                    <path
                                        ...
                                        id="Rectangle-17" stroke="#141C3A" stroke-width="8" fill="#6E07F3"/>
                                    <path
                                        ...
                                        id="Rectangle-19" stroke="#141C3A" stroke-width="8" fill="#FFFFFF"/>
                                    <path
                                ...
                                <g id="Group-94" transform="translate(199.000000, 589.000000)"
                                   fill="#141C3A"
                                   fill-rule="nonzero">
                                    <path
                ...
                <div className="container-fluid">
                    <div className="container">
                        <div className="block-colored-text text-center">
                            ...
                            <p className="block-colored-text__info lh-base">"Hello world! I'm a programmer on the hunt for a new
                                job. When I'm not writing code,
                                you can usually find me trying to explain what I do to my parents, petting my cat
